...
program
    ...
    .action(async () => {
        ...
        const PROVIDERS = [
            {
                ...
                models: {
                    thinking: { provider: "anthropic" as const, model: "claude-4.5-opus", maxTokens: 16000, temperature: 1, costPer1kInput: 0.015, costPer1kOutput: 0.075 },
                    expensive: { provider: "anthropic" as const, model: "claude-4-sonnet", maxTokens: 8000, temperature: 0.7, costPer1kInput: 0.003, costPer1kOutput: 0.015 },
                    cheap: { provider: "anthropic" as const, model: "claude-4-haiku", maxTokens: 4000, temperature: 0.5, costPer1kInput: 0.0008, costPer1kOutput: 0.004 },
                },
            },
            {
                ...
                models: {
                    thinking: { provider: "openai" as const, model: "chatgpt-5.2", maxTokens: 16000, temperature: 1, costPer1kInput: 0.005, costPer1kOutput: 0.015 },
                    expensive: { provider: "openai" as const, model: "chatgpt-5.2", maxTokens: 8000, temperature: 0.7, costPer1kInput: 0.005, costPer1kOutput: 0.015 },
                    cheap: { provider: "openai" as const, model: "gpt-5.2-mini", maxTokens: 4000, temperature: 0.5, costPer1kInput: 0.0003, costPer1kOutput: 0.0012 },
                },
            },
            {
                ...
                models: {
                    thinking: { provider: "google" as const, model: "gemini-3-flash-preview", maxTokens: 16000, temperature: 1, costPer1kInput: 0.00125, costPer1kOutput: 0.005 },
                    expensive: { provider: "google" as const, model: "gemini-3-flash-preview", maxTokens: 8000, temperature: 0.7, costPer1kInput: 0.00125, costPer1kOutput: 0.005 },
                    cheap: { provider: "google" as const, model: "gemini-3-flash-preview", maxTokens: 4000, temperature: 0.5, costPer1kInput: 0.0001, costPer1kOutput: 0.0004 },
                },
            },
            {
                ...
                envKey: "OLLAMA_HOST",
                models: {
                    thinking: { provider: "ollama" as const, model: "llama4", maxTokens: 16000, temperature: 0.7 },
                    expensive: { provider: "ollama" as const, model: "llama4", maxTokens: 8000, temperature: 0.7 },
                    cheap: { provider: "ollama" as const, model: "llama4", maxTokens: 4000, temperature: 0.3 },
                },
            },
        ];
        ...
        const modelConfig = {
            ...
            local: { provider: "ollama" as const, model: "llama4", maxTokens: 4000, temperature: 0.3 },
        };
...
program
    ...
    .action(async () => {
        ...
        if (!plan) {
            console.log(
                chalk.yellow("No execution plan found. Run /breakdown in chat first.")
            );
            return;
        }
